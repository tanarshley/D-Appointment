    ...
    <body style="overflow: hidden;">
        ...
        <div class="d-flex align-items-start">
            <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical" style="background-color: rgb(250, 250, 250); height: 75em; padding: 6px; width: 10%;">
                ...
                <a href="{{ route('admin.doctors') }}" class="nav-link" id="v-pills-doctors-tab" type="button" role="tab" aria-controls="v-pills-doctors" aria-selected="true">Doctors</a>
                <a href="{{ route('admin.patients') }}" class="nav-link active" id="v-pills-patients-tab" type="button" role="tab" aria-controls="v-pills-patients" aria-selected="false">Patients</a>
            ...
            <div class="tab-content" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-patients" role="tabpanel" aria-labelledby="v-pills-patients-tab" tabindex="0">
                    <div class="row">
                        <div class="col">
                ...
                <div class="container" style="width: 300%;">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="title">List of all Registered Patients</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach($patients as $patient)
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#viewPatientModal{{ $patient->patient_id}}">View</a>
                                                    <a type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#ConfirmRemoveModal{{ $patient->patient_id }}">Remove</a>
                                                </td>
                                            </tr>

                                                                                         <!--  View Doctor info  Modal -->
                                                                                         <div class="modal fade" id="viewPatientModal{{ $patient->patient_id }}" tabindex="-1" aria-labelledby="viewPatientModalLabel" aria-hidden="true">
                                                                                            <div class="modal-dialog">
                                                                                                <div class="modal-content">
                                                                                                    <div class="modal-header">
                                                                                                        <h5 class="modal-title" id="viewPatientModalLabel">{{ $patient->name }}</h5>
                                                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                                                    </div>
                                                                                                    <div class="modal-body">
                                                                                                            <input type="text" name="id" value="{{ $patient->patient_id }}" hidden readonly>

                                                                                                            <div class="profile-img text-center">
                                                                                                                @if($patient->profile_picture == "default-avatar.png")
                                                                                                                    <img src="{{ asset($patient->profile_picture) }}" class="img-fluid" alt="{{ $patient->name }} photo"  style="width: 110px; height: 110px; border-radius: 50%; margin-bottom: 12px;">
                                                                                                                    @else
                                                                                                                    <img src="{{ asset('/uploads/patients/'.$patient->profile_picture) }}" class="img-fluid" alt="{{ $patient->name }} photo" style="width: 110px; height: 110px; border-radius: 50%; margin-bottom: 12px;">
                                                                                                                @endif
                                                                                                            </div>
                                                                                                            ...
                                                                                                            <div class="form-group" style="margin-top: 12px;">
                                                                                                                ...
                                                                                                                <input type="text" class="form-control" id="dob" name="date_of_birth" value="{{ $patient->date_of_birth }}" readonly>
                                                                                                            </div>

                                                                                                            <div class="form-group" style="margin-top: 12px;">
                                                                                                                <label for="phone">Phone number</label>
                                                                                                                <input type="text" class="form-control" id="phone" name="phone_number" value="{{ $patient->phone_number }}" readonly>
                                                                                                            </div>

                                                                                                            <div class="form-group" style="margin-top: 12px;">
                                                                                                                <label for="address">Address</label>
                                                                                                                <input type="text" class="form-control" id="address" name="address" value="{{ $patient->address }}" readonly>
                                                                                                            </div>
                                            ...
                                            <div class="modal fade" id="ConfirmRemoveModal{{ $patient->patient_id }}" tabindex="-1" aria-labelledby="ConfirmRemoveModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="ConfirmRemoveModalLabel">{{ $patient->name }}</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="alert alert-danger" role="alert">
                                                                Deleting this patient will also delete all the appointments and records associated with this account.
                                                           </div>
                                                            <form action="{{ route('admin.confirmRemovePatient', $patient->patient_id) }}" method="POST">
                                                                @csrf
